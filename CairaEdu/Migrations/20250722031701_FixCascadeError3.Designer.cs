...
namespace CairaEdu.Migrations
{
    ...
    [Migration("20250722031701_FixCascadeError3")]
    partial class FixCascadeError3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CairaEdu.Data.Entities.Curso", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Nombre", "CicloLectivoId")
                        .IsUnique()
            ...
            modelBuilder.Entity("CairaEdu.Data.Entities.EstudianteXParalelo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CairaEdu.Data.Entities.Paralelo", b =>
                {
                    ...
                    b.HasIndex("Nombre", "CursoId")
                        .IsUnique()
                        .HasDatabaseName("UX_Paralelo_Nombre_Curso");

                    b.ToTable("Paralelo", (string)null);
                });
            ...
            modelBuilder.Entity("CairaEdu.Data.Entities.EstudianteXParalelo", b =>
                {
                    b.HasOne("CairaEdu.Data.Identity.ApplicationUser", "Estudiante")
                        .WithMany()
            ...
            modelBuilder.Entity("CairaEdu.Data.Entities.Paralelo", b =>
                {
                    b.HasOne("CairaEdu.Data.Entities.Curso", "Curso")
                        .WithMany("Paralelos")
